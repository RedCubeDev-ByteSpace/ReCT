...
namespace ReCT.Tests.CodeAnalysis.Syntax
{
    public class LexerTests
    {
        ...
        private static bool RequiresSeparator(SyntaxKind t1Kind, SyntaxKind t2Kind)
        {
            ...
            if (t1Kind == SyntaxKind.NotToken && t2Kind == SyntaxKind.AssignToken)
                return true;

            if (t1Kind == SyntaxKind.NotToken && t2Kind == SyntaxKind.EqualsToken)
                return true;

            if (t1Kind == SyntaxKind.AssignToken && t2Kind == SyntaxKind.AssignToken)
                return true;

            if (t1Kind == SyntaxKind.AssignToken && t2Kind == SyntaxKind.EqualsToken)
                return true;

            if (t1Kind == SyntaxKind.LessToken && t2Kind == SyntaxKind.AssignToken)
                return true;

            if (t1Kind == SyntaxKind.LessToken && t2Kind == SyntaxKind.EqualsToken)
                return true;

            if (t1Kind == SyntaxKind.GreaterToken && t2Kind == SyntaxKind.AssignToken)
                return true;
